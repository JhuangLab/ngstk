...
test_that("fusions_filter", {
  ...
  result_1 <- fusions_filter(input_data, mhander_extra_params = list(gene_5 = 1, gene_3 = 2, any_gene = "TCF3"))
  result_2 <- fusions_filter(input_data, mhander_extra_params = list(gene_3 = 2, right_gene = "GYPA"))
  result_3 <- fusions_filter(input_data, mhander_extra_params = list(gene_5 = 1, left_gene = "GYPA"))
  result_3 <- fusions_filter(input_data, mhander_extra_params = list(gene_5 = 1, left_gene = "GYPA"))
  result_4 <- fusions_filter(input_data, mhander_extra_params = list(gene_5 = 1, gene_3 = 2, left_gene = "GYPE", 
    right_gene = "GYPA"))
